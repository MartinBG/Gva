...
var config = {
  version: '1.0.0',
  msbuild: {
    projFile: '../Gva.Web.Host/Gva.Web.Host.csproj',
    iisAppName: 'Gva',
    packageLocation: '../build/gva/gva%s.zip' //location is relative to the csproj file
  },
  outputDir: '../Gva.Web.Host/App/',
  jsDir: 'js/',
  cssDir:'css/',
