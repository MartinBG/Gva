  ...
  angular.module('gva').config(['l10nProvider', function (l10n) {
    l10n.add('bg-bg', {
      ...
      states: {
        ...
        'root.aircrafts.view.debts.new': 'Нов залог',
        'root.aircrafts.view.debts.edit': 'Преглед на залог',
        'root.aircrafts.view.debtsFM': 'Залози',
        'root.aircrafts.view.debtsFM.new': 'Нов залог',
        'root.aircrafts.view.debtsFM.edit': 'Преглед на залог',
