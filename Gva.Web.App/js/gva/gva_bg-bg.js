    ...
    l10n.add('bg-bg', {
      ...
      sModeCodes: {
        search: {
          'new': 'Нов Код',
          search: 'Търси',
          codeHex: 'Код в шестнадесетична бр.с-ма',
          type: 'Вид код',
          description: 'Описание',
        ...
        sModeCodeDataDirective: {
          codeIn: 'Код в:',
          hexadecimal: 'Шестнадесетична бр.с-ма',
      ...
      aircrafts: {
        ...
        newRegWizzard: {
          ...
          regMarkIsConnectedToSModeCode: 
            'Желаният рег. знак ще бъде свързан със s код (в шестнадесетична бр. с-ма):'
        },
        editReg: {
      ...
      errorTexts: {
        ...
        notValidPaperData: 'Съществува хартия с това наименованието'
      },
      defaultErrorTexts: {
        required: 'Задължително поле',
