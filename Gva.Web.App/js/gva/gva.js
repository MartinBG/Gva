...
(function (angular) {
  ...
  angular.module('gva', [
    ...
    $stateProvider
      ...
      .state(['root.applications.search'                           , '?fromDate&toDate&personLin&aircraftIcao&organizationUin&stage'                           , ['@root'                  , 'js/gva/applications/views/applicationsSearch.html'             , 'ApplicationsSearchCtrl'        ]])
    ...
    $stateProvider
      ...
      .state(['root.aircrafts.registrations'                            , '/registrations?certNumber&actNumber&regMark', ['@root'               , 'js/gva/aircrafts/views/aircraftsRegistrationsSearch.html'               , 'AircraftsRegistrationsSearchCtrl']])
