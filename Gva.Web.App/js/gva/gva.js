...
(function (angular) {
  ...
  angular.module('gva', [
    ...
    $stateProvider
      ...
      .state(['root.applications.new.editPart'                     , '/:lotId/:setPartPath/:ind?appId&isNew'                                                   , ['@root'                  , 'js/gva/applications/views/applicationsEditPart.html'           , 'AppEditPartCtrl'               ]])
      ...
      .state(['root.applications.edit.data'                        , '/:lotId/:setPartPath/:ind'                                                               , ['@root.applications.edit', 'js/gva/applications/views/applicationsEditPart.html'           , 'AppEditPartCtrl'               ]])
