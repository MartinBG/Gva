...
(function (angular) {
  ...
  angular.module('gva', [
    ...
    $stateProvider
      ...
      .state(['root.applications.edit.data'                        , '/data'                                                                                        , ['@root.applications.edit', 'js/gva/applications/views/applicationsEditPart.html'           , 'AppEditPartCtrl'               ]])
      ...
      .state(['root.applications.edit.examSyst'                    , '/examSyst'                                                                                    , ['@root.applications.edit', 'js/gva/applications/views/appExamSyst/appExamSyst.html'        , 'AppExamSystCtrl'               ]]);
  }]).config(['scModalProvider', function (scModalProvider) {
    scModalProvider
    ...
    $stateProvider
      ...
      .state(['root.stampedDocuments'                                      , '/stampedDocuments?isOfficiallyReissuedId&licenceNumber&lin&uin&names&stampNumber&limit&offset'                                                                               , ['@root'                                            , 'js/gva/persons/views/stampedDocuments/stampedDocuments.html'                                 , 'StampedDocumentsCtrl'            ]])
