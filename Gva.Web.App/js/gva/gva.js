...
(function (angular) {
  ...
  angular.module('gva', [
    ...
    $stateProvider
      ...
      .state(['root.applications.edit.case.addPart.choosePublisher', '/choosepublisher?name&publisherType'                                                , ['@root.applications.edit', 'js/gva/common/views/publishers/choosePublisher.html'           , 'ChoosePublisherCtrl'           ]])
    ...
    $stateProvider
      ...
      .state(['root.persons.view.licences.new.newTraining.choosePublisher' , '/choosepublisher?name&publisherType'       , ['@root.persons.view', 'js/gva/common/views/publishers/choosePublisher.html'        , 'ChoosePublisherCtrl'          ]])
      ...
      .state(['root.persons.view.licences.new.newCheck.choosePublisher'    , '/choosepublisher?name&publisherType'       , ['@root.persons.view', 'js/gva/common/views/publishers/choosePublisher.html'        , 'ChoosePublisherCtrl'          ]])
      ...
      .state(['root.persons.view.licences.edit.newTraining.choosePublisher', '/choosepublisher?name&publisherType'       , ['@root.persons.view', 'js/gva/common/views/publishers/choosePublisher.html'        , 'ChoosePublisherCtrl'          ]])
      ...
      .state(['root.persons.view.licences.edit.newCheck.choosePublisher'   , '/choosepublisher?name&publisherType'       , ['@root.persons.view', 'js/gva/common/views/publishers/choosePublisher.html'        , 'ChoosePublisherCtrl'          ]])
      ...
      .state(['root.persons.view.checks.new.choosePublisher'            , '/choosepublisher?name&publisherType'        , ['@root.persons.view', 'js/gva/common/views/publishers/choosePublisher.html'                 , 'ChoosePublisherCtrl'          ]])
      ...
      .state(['root.persons.view.checks.edit.choosePublisher'           , '/choosepublisher?name&publisherType'        , ['@root.persons.view', 'js/gva/common/views/publishers/choosePublisher.html'                 , 'ChoosePublisherCtrl'          ]])
      ...
      .state(['root.persons.view.documentTrainings.new.choosePublisher' , '/choosepublisher?name&publisherType'        , ['@root.persons.view', 'js/gva/common/views/publishers/choosePublisher.html'                 , 'ChoosePublisherCtrl'          ]])
      ...
      .state(['root.persons.view.documentTrainings.edit.choosePublisher', '/choosepublisher?name&publisherType'        , ['@root.persons.view', 'js/gva/common/views/publishers/choosePublisher.html'                 , 'ChoosePublisherCtrl'          ]])
      ...
      .state(['root.persons.view.documentOthers.new.choosePublisher'    , '/choosepublisher?name&publisherType'        , ['@root.persons.view', 'js/gva/common/views/publishers/choosePublisher.html'                 , 'ChoosePublisherCtrl'          ]])
      ...
      .state(['root.persons.view.documentOthers.edit.choosePublisher'   , '/choosepublisher?name&publisherType'        , ['@root.persons.view', 'js/gva/common/views/publishers/choosePublisher.html'                 , 'ChoosePublisherCtrl'          ]])
