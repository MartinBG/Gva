...
(function (angular) {
  ...
  angular.module('gva', [
    ...
    $stateProvider
      ...
      .state(['root.personsReports.documents'                              , '/documents?limit&medClassId&publisher&docNumber&limitationId&typeId&documentRole&fromDatePeriodFrom&fromDatePeriodTo&toDatePeriodFrom&toDatePeriodTo&lin'             , ['@root.personsReports'                             , 'js/gva/persons/views/personsReports/personReportDocuments.html'                              , 'PersonReportDocumentsCtrl'       ]])
      .state(['root.personsReports.licences'                               , '/licences?limit&limitationId&lin&licenceTypeId&licenceActionId&fromDatePeriodFrom&fromDatePeriodTo&toDatePeriodFrom&toDatePeriodTo'                                   , ['@root.personsReports'                             , 'js/gva/persons/views/personsReports/personReportLicences.html'                               , 'PersonReportLicencesCtrl'        ]])
      .state(['root.personsReports.ratings'                                , '/ratings?limit&limitationId&ratingTypeId&ratingClassId&authorizationId&aircraftTypeCategoryId&lin&fromDatePeriodFrom&fromDatePeriodTo&toDatePeriodFrom&toDatePeriodTo', ['@root.personsReports'                             , 'js/gva/persons/views/personsReports/personReportRatings.html'                                , 'PersonReportRatingsCtrl'         ]]);
  }]).config(['scModalProvider', function (scModalProvider) {
    scModalProvider
