...
(function (angular) {
  ...
  angular.module('gva', [
    ...
    $stateProvider
      ...
      .state(['root.printableDocs'                                         , '/printableDocs?lin&uin&names&licenceType&licenceAction&limit&offset'                                                                                            , ['@root'                                            , 'js/gva/persons/views/printableDocs/printableDocsSearch.html'                                 , 'PrintableDocsSearchCtrl'         ]])
      .state(['root.stampedDocuments'                                      , '/stampedDocuments?lin&uin&names&stampNumber&limit&offset'                                                                                                       , ['@root'                                            , 'js/gva/persons/views/stampedDocuments/stampedDocuments.html'                                 , 'StampedDocumentsCtrl'            ]])
      ...
      .state(['root.personsReports.documents'                              , '/documents?publisher&docNumber&limitationId&typeId&documentRole&fromDatePeriodFrom&fromDatePeriodTo&toDatePeriodFrom&toDatePeriodTo&lin'                        , ['@root.personsReports'                             , 'js/gva/persons/views/personsReports/personReportDocuments.html'                              , 'PersonReportDocumentsCtrl'       ]])
      .state(['root.personsReports.licences'                               , '/licences?limitationId&lin&licenceTypeId&licenceActionId&fromDatePeriodFrom&fromDatePeriodTo&toDatePeriodFrom&toDatePeriodTo'                                   , ['@root.personsReports'                             , 'js/gva/persons/views/personsReports/personReportLicences.html'                               , 'PersonReportLicencesCtrl'        ]])
      .state(['root.personsReports.ratings'                                , '/ratings?limitationId&ratingTypeId&ratingClassId&authorizationId&aircraftTypeCategoryId&lin&fromDatePeriodFrom&fromDatePeriodTo&toDatePeriodFrom&toDatePeriodTo', ['@root.personsReports'                             , 'js/gva/persons/views/personsReports/personReportRatings.html'                                , 'PersonReportRatingsCtrl'         ]]);
  }]).config(['scModalProvider', function (scModalProvider) {
    scModalProvider
