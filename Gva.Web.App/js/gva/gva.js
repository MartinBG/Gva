...
(function (angular) {
  ...
  angular.module('gva', [
    ...
    $stateProvider
      ...
      .state(['root.persons.view.licences.new.newCheck.choosePublisher'    , '/choosepublisher?text&publisherTypeAlias'  , ['@root.persons.view', 'js/gva/common/views/publishers/choosePublisher.html'        , 'ChoosePublisherCtrl'          ]])
      ...
      .state(['root.persons.view.licences.edit.newCheck.choosePublisher'   , '/choosepublisher?text&publisherTypeAlias'  , ['@root.persons.view', 'js/gva/common/views/publishers/choosePublisher.html'        , 'ChoosePublisherCtrl'          ]])
