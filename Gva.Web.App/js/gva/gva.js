...
(function (angular) {
  ...
  angular.module('gva', [
    ...
    scaffoldingProvider.form({
      name: 'gvaPersonCommonDocDetails',
      templateUrl: 'js/gva/persons/forms/personCommonDocDetails.html',
      controller: 'PersonCommonDocDetailsCtrl'
    });
    scaffoldingProvider.form({
    ...
    scaffoldingProvider.form({
      ...
      controller: 'PersonDocumentExamCtrl'
    });
    scaffoldingProvider.form({
      name: 'gvaPersonExam',
