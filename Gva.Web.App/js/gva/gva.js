...
(function (angular) {
  ...
  angular.module('gva', [
    ...
    $stateProvider
      ...
      .state(['root.personsReports.documents'                              , '/documents?limitationId&typeId&documentRole&fromDate&toDate&lin'                                            , ['@root.personsReports'                             , 'js/gva/persons/views/personsReports/personReportDocuments.html'                              , 'PersonReportDocumentsCtrl'       ]])
      .state(['root.personsReports.licences'                               , '/licences?limitationId&lin&licenceTypeId&fromDate&toDate&licenceActionId'                                   , ['@root.personsReports'                             , 'js/gva/persons/views/personsReports/personReportLicences.html'                               , 'PersonReportLicencesCtrl'        ]])
      .state(['root.personsReports.ratings'                                , '/ratings?limitationId&fromDate&toDate&ratingTypeId&ratingClassId&authorizationId&aircraftTypeCategoryId&lin', ['@root.personsReports'                             , 'js/gva/persons/views/personsReports/personReportRatings.html'                                , 'PersonReportRatingsCtrl'         ]]);
  }]).config(['scModalProvider', function (scModalProvider) {
    scModalProvider
