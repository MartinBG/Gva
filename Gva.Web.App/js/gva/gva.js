...
(function (angular) {
  ...
  angular.module('gva', [
    ...
    $stateProvider
      ...
      .state(['root.persons.view.licences.view.editions.edit.ratings'      , '/ratings'                                                                    , ['@root.persons.view.licences.view.editions.edit'   , 'js/gva/persons/views/licences/licenceEditions/licenceEditionsEditRatings.html'               , 'LicenceEditionsEditRatingsCtrl'  ]])
      ...
      .state(['root.personsReferences'                                     , '/personsReferences'                                                          , ['@root'                                            , 'js/gva/persons/views/references/personReferenceView.html'                                                                        ]])
      .state(['root.personsReferences.documents'                           , '/documents?typeId&documentPart&fromDate&toDate'                              , ['@root.personsReferences'                          , 'js/gva/persons/views/references/personReferenceDocuments.html'                               , 'PersonReferenceDocumentsCtrl'    ]])
      .state(['root.personsReferences.licences'                            , '/licences?lin&licenceTypeId&fromDate&toDate&licenceActionId'                 , ['@root.personsReferences'                          , 'js/gva/persons/views/references/personReferenceLicences.html'                                , 'PersonReferenceLicencesCtrl'     ]]);
  }]).config(['scModalProvider', function (scModalProvider) {
    scModalProvider
