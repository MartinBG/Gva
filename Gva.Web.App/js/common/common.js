...
(function (angular) {
  ...
  angular.module('common', [
    ...
    $stateProvider
      ...
      .state(['root.nomenclatures.search.applications'         , '/applications'         , ['@root.nomenclatures.search', 'js/common/nomenclatures/views/categoryNoms.html'          , 'CategoryNomsCtrl'            ]])
      .state(['root.nomenclatures.search.inspections'          , '/inspections'          , ['@root.nomenclatures.search', 'js/common/nomenclatures/views/categoryNoms.html'          , 'CategoryNomsCtrl'            ]])
      ...
      .state(['root.nomenclatures.search.documents'            , '/documents'            , ['@root.nomenclatures.search', 'js/common/nomenclatures/views/categoryNoms.html'          , 'CategoryNomsCtrl'            ]])
      .state(['root.nomenclatures.search.orgApprovals'         , '/orgApprovals'         , ['@root.nomenclatures.search', 'js/common/nomenclatures/views/categoryNoms.html'          , 'CategoryNomsCtrl'            ]])
