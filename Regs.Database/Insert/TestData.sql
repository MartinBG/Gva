...
VALUES
    ...
    (10            , 1             , 'edition'         , N'ratings/\d+/editions/\d+'          , N'{}'   ),
    (11            , 1             , 'flyingExperience', N'personFlyingExperiences/\d+'       , N'{}'   ),
    (12            , 1             , 'personStatus'    , N'personStatuses/\d+'                , N'{}'   ),
    (13            , 1             , 'licence'         , N'licences/\d+'                      , N'{}'   ),
    (14            , 1             , 'licenceEdition'  , N'licences/\d+/editions/\d+'         , N'{}'   ),
    (15            , 1             , 'rating'          , N'ratings/\d'                        , N'{}'   ),
    (16            , 1             , 'ratingEdition'   , N'ratings/\d/editions/\d'            , N'{}'   )
GO
