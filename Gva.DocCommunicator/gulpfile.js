...
config = {
  version: '1.0.0',
  msbuild: {
    projFile: '../Gva.DocCommunicator/Gva.DocCommunicator.csproj',
    iisAppName: 'DocCommunicator',
    packageLocation: '../build/gva_doccomm/gva_doccomm%s.zip' //location is relative to the csproj file
  },
};
