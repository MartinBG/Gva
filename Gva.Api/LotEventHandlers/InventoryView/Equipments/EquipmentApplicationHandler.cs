...
{
    public class EquipmentApplicationHandler : CommitEventHandler<GvaViewInventoryItem>
    {
        private IUserRepository userRepository;

        public EquipmentApplicationHandler(IUnitOfWork unitOfWork, IUserRepository userRepository)
            : base(
