            ...
            foreach (var flyingExperienceVersion in flyingExperiences)
            {
                ...
                if (!caseTypeId.HasValue || lotFile != null)
                {
                    ...
                    flyingExpViewDOs.Add(new PersonFlyingExperienceViewDO()
                    {
                        ...
                        RatingClass = flyingExperienceVersion.Content.RatingClassId.HasValue ? this.nomRepository.GetNomValue("ratingClases", flyingExperienceVersion.Content.RatingClassId.Value) : null,
                        RatingTypes = flyingExperienceVersion.Content.RatingTypes.Count > 0 ? this.nomRepository.GetNomValues("ratingClases", flyingExperienceVersion.Content.RatingTypes.ToArray()).ToList() : null,
