...
{
    public class PersonLangCertViewDO
    {
        public PersonLangCertViewDO() 
        {
            LangLevelEntries = new List<PersonLangLevelViewDO>();
        ...
        public List<PersonLangLevelViewDO> LangLevelEntries { get; set; }
