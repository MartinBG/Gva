...
{
    public class OrganizationCertGroundServiceOperatorDO
    {
        public OrganizationCertGroundServiceOperatorDO()
        {
            this.GroundServiceOperatorActivityTypes = new List<NomValue>();
        ...
        public List<NomValue> GroundServiceOperatorActivityTypes { get; set; }
