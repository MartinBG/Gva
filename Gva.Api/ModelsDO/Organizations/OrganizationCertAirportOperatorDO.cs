...
{
    public class OrganizationCertAirportOperatorDO
    {
        public OrganizationCertAirportOperatorDO()
        {
            this.AirportoperatorActivityTypes = new List<NomValue>();
        ...
        public List<NomValue> AirportoperatorActivityTypes { get; set; }
