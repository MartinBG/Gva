        ...
        public object GetData(int lotId, string path)
        {
            ...
            var json = new
            {
                root = new
                {
                    ...
                    DATE_AND_PLACE_OF_BIRTH = string.Format("{0} {1}, {2}",
                    personData.DateOfBirth.HasValue ? personData.DateOfBirth.Value.ToString("dd.MM.yyyy") : "",
                    country != null ? country.NameAlt : "",
                    personData.PlaceOfBirthId.HasValue ? this.nomRepository.GetNomValue("cities", personData.PlaceOfBirthId.Value).NameAlt : ""),
