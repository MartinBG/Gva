...
namespace Gva.Api.WordTemplates
{
    public class Atcl1Licence : IDataGenerator
    {
            ...
            IEnumerable<PersonLangCertDO> includedLangCerts)
        {
            ...
            var theoreticalExamsTransitionalEducation = includedTrainings
                .Where(t => documentRoleCodes.Contains(t.DocumentRole.Code) && t.DocumentRole.Code == theoreticalExamTransitionalEducationRole.Code)
            ...
            var practicalExamsPreliminaryEducation = includedTrainings
                .Where(t => documentRoleCodes.Contains(t.DocumentRole.Code) && t.DocumentRole.Code == practicalExamPreliminaryEducationRole.Code)
                .OrderBy(t => t.DocumentDateValidFrom)
                .Select(t =>
                    new
                    {
            ...
            var accessOrdersPracticalEducation = includedTrainings
                .Where(t => documentRoleCodes.Contains(t.DocumentRole.Code) && t.DocumentRole.Code == accessOrderPracticalEducationRole.Code)
                .OrderBy(t => t.DocumentDateValidFrom)
                .Select(t =>
                    new
                    {
            ...
            var practicalExamsToGainAccess = includedTrainings
                .Where(t => documentRoleCodes.Contains(t.DocumentRole.Code) && t.DocumentRole.Code == practExamToGainAccessRole.Code)
                .OrderBy(t => t.DocumentDateValidFrom)
                .Select(t =>
                    new
                    {
            ...
            var accessOrdersToWorkAlone = includedTrainings
                .Where(t => documentRoleCodes.Contains(t.DocumentRole.Code) && t.DocumentRole.Code == accessOrderWorkAloneRole.Code)
                .OrderBy(t => t.DocumentDateValidFrom)
                .Select(t =>
                    new
                    {
            ...
            var RPcerts = includedTrainings
                .Where(t => documentRoleCodes.Contains(t.DocumentRole.Code) && t.DocumentRole.Code == RPcertRole.Code)
                .OrderBy(t => t.DocumentDateValidFrom)
                .Select(t =>
                    new
                    {
