        ...
        public object GetData(int lotId, string path)
        {
            ...
            var json = new
            {
                root = new
                {
                    ...
                    SEX = personData.SexId.HasValue ? this.nomRepository.GetNomValue("gender", personData.SexId.Value).Code : null,
                    ...
                    DATE_OF_BIRTH1 = string.Format("{0:dd.MM.yyyy} {1}",
                        ...
                        personData.PlaceOfBirthId.HasValue ? this.nomRepository.GetNomValue("cities", personData.PlaceOfBirthId.Value).Name : null),
                    ADDR = address.Item2,
