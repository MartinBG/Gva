...
namespace Gva.Api.WordTemplates
{
    public class ExaminerCert : IDataGenerator
    {
        ...
        public object GetData(int lotId, string path)
        {
            ...
            var ratingsPerExaminerAndAuthCodes = InstructorExaminerUtils.GetRatingsPerInstructorExaminerByAuthCode(includedRatings, ratingEditions, "FC", this.nomRepository);
