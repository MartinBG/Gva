...
namespace Gva.Api.WordTemplates
{
    public class Pilot142year2013 : IDataGenerator
    {
        ...
        public object GetData(int lotId, string path)
        {
            ...
            List<object> instructorData3 = this.GetRatingsDataByCode(includedRatings, ratingEditions, FTgroup);
            List<object> examinerData3 = this.GetRatingsDataByCode(includedRatings, ratingEditions, FCgroup);
            ...
            var ratings = this.GetRatings(includedRatings, ratingEditions, authorizationGroupIds);
            var ratings2 = this.GetRatings2(includedRatings, ratingEditions, authorizationGroupIds);
            ...
            var json = new
            {
                root = new
                {
                    ...
                    T_RATING = ratings,
                    T_RATING2 = ratings,
                    T_RATING3 = Utils.FillBlankData(ratings2, 10),
                    INSTRUCTOR3 = Utils.FillBlankData(instructorData3, 5),
                    EXAMINER3 = Utils.FillBlankData(examinerData3, 5),
        ...
        private List<object> GetRatingsDataByCode(
           IEnumerable<PartVersion<PersonRatingDO>> includedRatings,
           IEnumerable<PartVersion<PersonRatingEditionDO>> ratingEditions,
            ...
            foreach (var edition in ratingEditions)
            {
                    ...
                    rating.Content.Authorization.Code != "RTO")
                {
                    ratings.Add(new
                    {
                        ...
                        CHECK_DATE = edition.Content.CheckDate,
                        CHECK_DATE_IR = edition.Content.CheckDateIR
                    });
                }
            }
        ...
        private List<object> GetRatings2(
            IEnumerable<PartVersion<PersonRatingDO>> includedRatings,
            IEnumerable<PartVersion<PersonRatingEditionDO>> ratingEditions,
            List<int> authorizationGroupIds)
        {
