        ...
        public JObject GetData(int lotId, string path, int index)
        {
            ...
            var json = new
            {
                root = new
                {
                    ...
                    L_LICENCE_TYPE_CA_CODE = JsonConvert.DeserializeObject<JObject>(licenceType.TextContent).Get<string>("codeCA"),
                    L_NAME1 = licenceType.Name,
                    L_NAME1_TRANS = licenceType.NameAlt,
                    L_LICENCE_TYPE_CA_CODE2 = JsonConvert.DeserializeObject<JObject>(licenceType.TextContent).Get<string>("codeCA"),
