...
namespace Common.Utils
{
    public class CodeGeneratorUtils
    {
        ...
        protected char GetRandomCharacter()
        {
            ...
            {
                upperBound = CodeGeneratorUtils.UBoundDigit;
            }
        ...
        public int Minimum
        {
            ...
            {
                this.minSize = value;
                if (CodeGeneratorUtils.DefaultMinimum > this.minSize)
                {
                    this.minSize = CodeGeneratorUtils.DefaultMinimum;
                }
            }
        }
        ...
        public int Maximum
        {
            ...
            set
            {
                ...
                {
                    this.maxSize = CodeGeneratorUtils.DefaultMaximum;
                }
            }
        }
