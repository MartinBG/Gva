...
namespace Aop.RioBridge
{
    public class AopRioBridgeMapperProfile : AutoMapper.Profile
    {
        ...
        {
            Mapper.CreateMap<Aop.Portal.RioObjects.IHeaderFooterDocumentsRioApplication, Common.Rio.PortalBridge.RioObjects.RioApplication>()
            ...
            Mapper.CreateMap<Aop.Portal.RioObjects.Enums.ElectronicDocumentDiscrepancyTypeNomenclature, Common.Rio.PortalBridge.RioObjects.ElectronicDocumentDiscrepancyTypeNomenclature>();
