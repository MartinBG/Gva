...
(function (angular) {
  ...
  function ChooseOrganizationPublisherCtrl(
    $state,
    $stateParams,
    $scope,
    Publisher,
  ...
  ChooseOrganizationPublisherCtrl.$inject = [
    '$state',
    '$stateParams',
    '$scope',
    'Publisher',
  ...
  ChooseOrganizationPublisherCtrl.$resolve = {
    publishers: [
      '$stateParams',
      'Publisher',
  ...
  angular.module('gva')
    .controller('ChooseOrganizationPublisherCtrl', ChooseOrganizationPublisherCtrl);
}(angular));
