...
(function (angular) {
  ...
  angular.module('gva', [
    ...
    $stateProvider
      ...
      .state(['root.applications.new.corrSelect'                   , '/corrSelect?displayName&email&stamp'                                                     , ['@root'                  , 'gva/applications/views/common/corrSelect.html'         , 'CorrSelectCtrl'                ]])
      .state(['root.applications.new.corrNew'                      , '/corrNew'                                                                                , ['@root'                  , 'gva/applications/views/common/corrNew.html'            , 'CorrNewCtrl'                   ]])
      .state(['root.applications.link'                             , '/link'                                                                                   , ['@root'                  , 'gva/applications/views/applicationsLink.html'          , 'ApplicationsLinkCtrl'          ]])
      .state(['root.applications.link.docSelect'                   , '/docSelect?fromDate&toDate&regUri&docName&docTypeId&docStatusId&corrs&units&stamp'       , ['@root'                  , 'gva/applications/views/common/docSelect.html'          , 'DocSelectCtrl'                 ]])
      .state(['root.applications.link.personSelect'                , '/personSelect?exact&lin&uin&names&licences&ratings&organization&stamp'                   , ['@root'                  , 'gva/applications/views/common/personSelect.html'       , 'PersonSelectCtrl'              ]])
      .state(['root.applications.link.personNew'                   , '/personNew'                                                                              , ['@root'                  , 'gva/applications/views/common/personNew.html'          , 'PersonNewCtrl'                 ]])
      .state(['root.applications.link.organizationSelect'          , '/organizationSelect?name&CAO&valid&organizationType&dateValidTo&dateCAOValidTo&uin&stamp', ['@root'                  , 'gva/applications/views/common/organizationSelect.html' , 'OrganizationSelectCtrl'        ]])
      ...
      .state(['root.applications.link.aircraftSelect'              , '/aircraftSelect?manSN&model&icao&stamp'                                                  , ['@root'                  , 'gva/applications/views/common/aircraftSelect.html'     , 'AircraftSelectCtrl'            ]])
      .state(['root.applications.link.aircraftNew'                 , '/aircraftNew'                                                                            , ['@root'                  , 'gva/applications/views/common/aircraftNew.html'        , 'AircraftNewCtrl'               ]])
      .state(['root.applications.link.airportSelect'               , '/airportSelect?name&icao&stamp'                                                          , ['@root'                  , 'gva/applications/views/common/airportSelect.html'      , 'AirportSelectCtrl'             ]])
      .state(['root.applications.link.airportNew'                  , '/airportNew'                                                                             , ['@root'                  , 'gva/applications/views/common/airportNew.html'         , 'AirportNewCtrl'                ]])
      .state(['root.applications.link.equipmentSelect'             , '/equipmentSelect?name&stamp'                                                             , ['@root'                  , 'gva/applications/views/common/equipmentSelect.html'    , 'EquipmentSelectCtrl'           ]])
    ...
    $stateProvider
      ...
      .state(['root.persons.view'                                       , '/:id?caseTypeId&appId'                      , ['@root'             , 'gva/persons/views/personsView.html'                               , 'PersonsViewCtrl'              ]])
    ...
    $stateProvider
      ...
      .state(['root.aircrafts.view'                                     , '/:id?appId'                                 , ['@root'               , 'gva/aircrafts/views/aircraftsView.html'                              , 'AircraftsViewCtrl'              ]])
      ...
      .state(['root.aircrafts.view.regsFM.new'                          , '/new?oldInd'                                , ['@root.aircrafts.view', 'gva/aircrafts/views/certRegsFM/regsNew.html'                         , 'CertRegsFMNewCtrl'              ]])
      .state(['root.aircrafts.view.regsFM.newWizzard'                   , '/newWizzard?oldInd'                         , ['@root.aircrafts.view', 'gva/aircrafts/views/certRegsFM/regsNewWizzard.html'                  , 'CertRegsFMNewWizzardCtrl'       ]])
    ...
    $stateProvider
      ...
      .state(['root.organizations.view'                                                          , '/:id?appId'                                 , ['@root'                   , 'gva/organizations/views/organizationsView.html'                                                                      , 'OrganizationsViewCtrl'                             ]])
      ...
      .state(['root.organizations.view.staffManagement.new.chooseEmployment'                     , '/chooseEmployment'                          , ['@root.organizations.view', 'gva/organizations/views/staffManagement/chooseEmployment.html'                                                       , 'ChooseEmploymentCtrl'                              ]])
      ...
      .state(['root.organizations.view.staffManagement.edit.chooseEmployment'                    , '/chooseEmployment'                          , ['@root.organizations.view', 'gva/organizations/views/staffManagement/chooseEmployment.html'                                                       , 'ChooseEmploymentCtrl'                              ]])
      ...
      .state(['root.organizations.view.approvals.new.chooseDocuments'                            , '/chooseDocuments?documentTypes'             , ['@root.organizations.view', 'gva/organizations/views/chooseDocuments/organizationsChooseDocuments.html'                                           , 'OrganizationsChooseDocumentsCtrl'                  ]])
      .state(['root.organizations.view.approvals.new.chooseLimitation'                          , '/chooseLimitation?index&limitationAlias'     , ['@root.organizations.view', 'gva/organizations/views/chooseLimitation/chooseLimitation.html'                                                      , 'ChooseLimitationCtrl'                              ]])
      .state(['root.organizations.view.approvals.edit'                                           , '/:ind'                                      , ['@root.organizations.view', 'gva/organizations/views/approvals/approvalsEdit.html'                                                                , 'ApprovalsEditCtrl'                                 ]])
      .state(['root.organizations.view.approvals.edit.chooseDocuments'                           , '/chooseDocuments?documentTypes'             , ['@root.organizations.view', 'gva/organizations/views/chooseDocuments/organizationsChooseDocuments.html'                                           , 'OrganizationsChooseDocumentsCtrl'                  ]])
      .state(['root.organizations.view.approvals.edit.chooseLimitation'                          , '/chooseLimitation?index&limitationAlias'    , ['@root.organizations.view', 'gva/organizations/views/chooseLimitation/chooseLimitation.html'                                                      , 'ChooseLimitationCtrl'                              ]])
      ...
      .state(['root.airports.view'                              , '/:id?appId'                               , ['@root'               , 'gva/airports/views/airportsView.html'                               , 'AirportsViewCtrl'              ]])
      ...
      .state(['root.airports.view.opers.new.chooseDocuments'    , '/chooseDocuments?documentTypes'           , ['@root.airports.view', 'gva/airports/views/chooseDocuments/chooseDocuments.html'             , 'AirportsChooseDocumentsCtrl'   ]])
      ...
      .state(['root.airports.view.opers.edit.chooseDocuments'   , '/chooseDocuments?documentTypes'           , ['@root.airports.view', 'gva/airports/views/chooseDocuments/chooseDocuments.html'             , 'AirportsChooseDocumentsCtrl'   ]])
      ...
      .state(['root.equipments.view'                              , '/:id?appId'                               , ['@root'               , 'gva/equipments/views/equipmentsView.html'                               , 'EquipmentsViewCtrl'             ]])
      ...
      .state(['root.equipments.view.opers.new.chooseDocuments'    , '/chooseDocuments?documentTypes'           , ['@root.equipments.view', 'gva/equipments/views/chooseDocuments/chooseDocuments.html'             , 'EquipmentsChooseDocumentsCtrl'  ]])
      ...
      .state(['root.equipments.view.opers.edit.chooseDocuments'   , '/chooseDocuments?documentTypes'           , ['@root.equipments.view', 'gva/equipments/views/chooseDocuments/chooseDocuments.html'             , 'EquipmentsChooseDocumentsCtrl'  ]])
