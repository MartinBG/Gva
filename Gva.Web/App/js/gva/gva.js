...
(function (angular) {
  ...
  angular.module('gva', [
    ...
    $stateProvider
      ...
      .state(['root.aircrafts.view.regsFM.newWizzard'                   , '/newWizzard'                                , ['@root.aircrafts.view', 'gva/aircrafts/views/certRegsFM/regsNewWizzard.html'                  , 'CertRegsFMNewWizzardCtrl'       ]])
