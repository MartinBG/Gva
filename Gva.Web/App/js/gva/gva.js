...
(function (angular) {
  ...
  angular.module('gva', [
    ...
    $stateProvider
      ...
      .state(['root.applications.search'                           , '?fromDate&toDate&lin'                                                                    , ['@root'                  , 'js/gva/applications/views/applicationsSearch.html'        , 'ApplicationsSearchCtrl'        ]])
    ...
    $stateProvider
      ...
      .state(['root.persons.view'                                       , '/:id?caseTypeId&appId'                      , ['@root'             , 'js/gva/persons/views/personsView.html'                               , 'PersonsViewCtrl'              ]])
    ...
    $stateProvider
      ...
      .state(['root.aircrafts.view'                                     , '/:id?appId'                                 , ['@root'               , 'js/gva/aircrafts/views/aircraftsView.html'                              , 'AircraftsViewCtrl'              ]])
    ...
    $stateProvider
      ...
      .state(['root.organizations.view'                                                          , '/:id?appId'                                 , ['@root'                   , 'js/gva/organizations/views/organizationsView.html'                                                                      , 'OrganizationsViewCtrl'                             ]])
      ...
      .state(['root.airports.view'                              , '/:id?appId'                               , ['@root'              , 'js/gva/airports/views/airportsView.html'                               , 'AirportsViewCtrl'              ]])
      ...
      .state(['root.equipments.view'                            , '/:id?appId'                               , ['@root'                , 'js/gva/equipments/views/equipmentsView.html'                               , 'EquipmentsViewCtrl'             ]])
