...
(function (angular) {
  ...
  angular.module('gva', [
    ...
    $stateProvider
      ...
      .state(['root.applications.edit.case.newFile'                , '/newFile'                                                                                                            , ['@root.applications.edit', 'gva/applications/views/applicationsEditNewFile.html' , 'ApplicationsEditNewFileCtrl' ]])
      .state(['root.applications.edit.case.addPart'                , '/addPart'                                                                                                            , ['@root.applications.edit', 'gva/applications/views/applicationsEditAddPart.html' , 'ApplicationsEditAddPartCtrl' ]])
      ...
      .state(['root.applications.edit.case.linkPart'               , '/linkPart '                                                                                                          , ['@root.applications.edit', 'gva/applications/views/applicationsEditLinkPart.html', 'ApplicationsEditLinkPartCtrl']]);
  }]).config(['$stateProvider', function ($stateProvider) {
    $stateProvider
