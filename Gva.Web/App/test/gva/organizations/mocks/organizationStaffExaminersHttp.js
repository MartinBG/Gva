...
(function (angular, _) {
  ...
  angular.module('app').config(function ($httpBackendConfiguratorProvider) {
    $httpBackendConfiguratorProvider
      .when('GET', '/api/organizations/:id/staffExaminers',
      ...
      .when('GET', '/api/organizations/:id/staffExaminers/:ind',
        function ($params, organizationLots) {
          var organization = _(organizationLots)
            .filter({ lotId: parseInt($params.id, 10) }).first();
      ...
      .when('POST', '/api/organizations/:id/staffExaminers',
      ...
      .when('POST', '/api/organizations/:id/staffExaminers/:ind',
        function ($params, $jsonData, organizationLots) {
          var organization = _(organizationLots)
            .filter({ lotId: parseInt($params.id, 10) }).first();
      ...
      .when('DELETE', '/api/organizations/:id/staffExaminers/:ind',
        function ($params, $jsonData, organizationLots) {
          var organization = _(organizationLots)
            .filter({ lotId: parseInt($params.id, 10) }).first();
