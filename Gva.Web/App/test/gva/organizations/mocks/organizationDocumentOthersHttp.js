...
(function (angular, _) {
  ...
  angular.module('app').config(function ($httpBackendConfiguratorProvider) {
    $httpBackendConfiguratorProvider
      .when(
      'GET',
      '/api/organizations/:id/documentOthers?number&typeid&publ&datef&pnumber',
      ...
      .when('GET', '/api/organizations/:id/documentOthers/:ind',
      ...
      .when('POST', '/api/organizations/:id/documentOthers',
      ...
      .when('POST', '/api/organizations/:id/documentOthers/:ind',
        function ($params, $jsonData, organizationLots) {
          var organization = _(organizationLots)
            .filter({ lotId: parseInt($params.id, 10) }).first();
      ...
      .when('DELETE', '/api/organizations/:id/documentOthers/:ind',
        function ($params, $jsonData, organizationLots) {
          var organization = _(organizationLots)
            .filter({ lotId: parseInt($params.id, 10) }).first();
