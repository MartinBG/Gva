...
(function (angular, _) {
  ...
  angular.module('app').config(function ($httpBackendConfiguratorProvider) {
    $httpBackendConfiguratorProvider
      .when('GET', '/api/organizations/:id/certGroundServiceOperatorsSnoOperational',
      ...
      .when('GET', '/api/organizations/:id/certGroundServiceOperatorsSnoOperational/:ind',
        function ($params, organizationLots) {
          var organization = _(organizationLots)
            .filter({ lotId: parseInt($params.id, 10) }).first();
      ...
      .when('POST', '/api/organizations/:id/certGroundServiceOperatorsSnoOperational',
      ...
      .when('POST', '/api/organizations/:id/certGroundServiceOperatorsSnoOperational/:ind',
        function ($params, $jsonData, organizationLots) {
          var organization = _(organizationLots)
            .filter({ lotId: parseInt($params.id, 10) }).first();
      ...
      .when('DELETE', '/api/organizations/:id/certGroundServiceOperatorsSnoOperational/:ind',
        function ($params, $jsonData, organizationLots) {
          var organization = _(organizationLots)
            .filter({ lotId: parseInt($params.id, 10) }).first();
