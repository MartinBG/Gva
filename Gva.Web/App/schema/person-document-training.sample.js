...
(function (module) {
  ...
  module.exports = {
    person1Training1: {
      ...
      licenceType : null,
      engLangLevel: null,
      personOtherDocumentType: nomenclatures.get('documentTypes', 'CtrlTalon'),
    ...
    person1Training3: {
      ...
      extraDataSUVD : null,
      engLangLevel: null,
      personOtherDocumentType: nomenclatures.get('documentTypes', 'CtrlCard'),
      personOtherDocumentRole: nomenclatures.get('documentRoles', 'Training'),
    ...
    person1Training4: {
      ...
      licenceType : nomenclatures.get('licenceTypes', 'CPA'),
      engLangLevel: null,
      personOtherDocumentType: nomenclatures.get('documentTypes', 'Certificate'),
