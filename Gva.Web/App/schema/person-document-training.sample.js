...
(function (module) {
  ...
  module.exports = {
    person1Training1: {
      ...
      documentRole: nomenclatures.get('documentRoles', 'Training'),
    ...
    person1Training3: {
      ...
      extraDataSUVD : null,
      engLangLevel: null,
      documentType: nomenclatures.get('documentTypes', 'CtrlCard'),
      documentRole: nomenclatures.get('documentRoles', 'Training'),
    ...
    person1Training4: {
      ...
      licenceType : nomenclatures.get('licenceTypes', 'CPA'),
      engLangLevel: null,
      documentType: nomenclatures.get('documentTypes', 'Certificate'),
      documentRole: nomenclatures.get('documentRoles', 'TheoreticalTraining'),
      valid: nomenclatures.get('boolean', 'true'),
      notes: '',
      bookPageNumber: '79',
      pageCount: 1
