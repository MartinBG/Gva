...
(function (module) {
  ...
  module.exports = {
    person1Training1: {
      ...
      personOtherDocumentRole: nomenclatures.get('personOtherDocumentRoles', 'Training'),
    ...
    person1Training4: {
      ...
      personOtherDocumentRole: nomenclatures.get('personOtherDocumentRoles', 'TheoreticalTraining'),
      valid: nomenclatures.get('boolean', 'true'),
      notes: '',
      bookPageNumber: '79',
      pageCount: 1
