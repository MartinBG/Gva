...
(function (module) {
  ...
  module.exports = {
    person1Check1: {
      ...
      personCheckDocumentType: nomenclatures.get('documentTypes', 'BaseTrainingForm'),
      personCheckDocumentRole: nomenclatures.get('documentRoles', 'FlightTest'),
    ...
    person1Check2: {
      ...
      personCheckDocumentType: nomenclatures.get('documentTypes', 'Authorisation'),
      personCheckDocumentRole: nomenclatures.get('documentRoles', 'PracticalCheck'),
