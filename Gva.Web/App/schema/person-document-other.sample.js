...
(function (module) {
  ...
  module.exports = {
    person1Doc1: {
      ...
      personOtherDocumentTypeId: nomenclatures.getId('personOtherDocumentTypes', 'Protocol'),
      personOtherDocumentRoleId: nomenclatures.getId('personOtherDocumentRoles', 'FlightTest'),
      valid: true,
      notes: '',
      bookPageNumber: '62',
      pageCount: 1
