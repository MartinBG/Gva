...
(function (angular) {
  ...
  angular.module('aop', [
    ...
    $stateProvider
      ...
      .state(['root.apps.edit.docSelect'                      , '/caseSelect?type&csFromDate&csToDate&csRegUri&csDocName&csDocTypeId&csDocStatusId&csCorrs&csUnits&csIsCase', ['@root'           , 'js/ems/docs/views/caseSelect.html'                   ,'AppDocSelectCtrl'    ]])
