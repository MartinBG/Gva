...
(function (angular) {
  ...
  angular.module('ems', [
    ...
    scaffoldingProvider.form({
      name: 'nomUnitData',
      templateUrl: 'js/ems/noms/forms/unitData.html'
    });
    scaffoldingProvider.form({
      name: 'emsCorrData',
    ...
    $stateProvider
      ...
      .state(['root.noms'                                     , '/noms'                                                                                                , ['@root'           , 'js/ems/noms/views/noms.html'                             ,'NomsCtrl'                 ]])
      .state(['root.noms.units'                               , '/units?name&unitTypeId&limit&offset'                                                                                                                                                                                ])
      .state(['root.noms.units.search'                        , ''                                                                                                     , ['@root'           , 'js/ems/noms/views/unitsSearch.html'                      ,'UnitsSearchCtrl'          ]])
      .state(['root.noms.units.new'                           , '/new'                                                                                                 , ['@root'           , 'js/ems/noms/views/unitsNew.html'                         ,'UnitsNewCtrl'             ]])
      .state(['root.noms.units.edit'                          , '/:id'                                                                                                 , ['@root'           , 'js/ems/noms/views/unitsEdit.html'                        ,'UnitsEditCtrl'            ]]);
  }]);
}(angular));
