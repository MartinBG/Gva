...
var config = {
  version: '1.0.0',
  msbuild: {
    projFile: '../Aop.Web.Host/Aop.Web.Host.csproj',
    iisAppName: 'Aop',
    packageLocation: '../build/aop/aop%s.zip' //location is relative to the csproj file
  },
  outputDir: '../Aop.Web.Host/App/',
  jsDir: 'js/',
  cssDir:'css/',
