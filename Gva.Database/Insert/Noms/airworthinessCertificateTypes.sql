...
INSERT INTO NomValues (NomValueId,NomId,Code,Name,NameAlt,ParentValueId,Alias,IsActive) VALUES(7777990,77770,N'A9',N'Удостоверение за летателна годност (Наредба 8)',N'Motor-hanglider',NULL,NULL,1);
INSERT INTO NomValues (NomValueId,NomId,Code,Name,NameAlt,ParentValueId,Alias,IsActive) VALUES(7777991,77770,N'AU',N'Удостоверение за летателна годност (СлВС)',N'Motor-hanglider',NULL,NULL,1);
GO
