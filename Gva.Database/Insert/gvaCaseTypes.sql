...
VALUES
    ...
    (7              , N'Инспектор'      , N'inspector'        ,           0,          1,(select LotSetId from LotSets where Alias = N'Person'      ), (select ClassificationId from Classifications where Alias = N'inspector'        )),
    (8              , N'Проверяващ ЛГ'  , N'awExaminer'       ,           0,          1,(select LotSetId from LotSets where Alias = N'Person'      ), (select ClassificationId from Classifications where Alias = N'awExaminer'       )),
