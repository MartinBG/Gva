...
INSERT INTO [RegisterIndexes]([RegisterIndexId], [Code], [Alias], [IsActive], [NumberFormat], [Name]) VALUES(4,N'000034',N'000034',1,N'000034-{0}-{1:dd.MM.yyyy}',N'Официален документен регистър');
