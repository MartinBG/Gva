...
CREATE TABLE [dbo].[GvaViewSModeCodes] (
    ...
    [RegMark]                NVARCHAR(MAX) NULL,
    [AircraftId]             INT           NULL,
    [RegistrationPartIndex]  INT           NULL,
	...
	CONSTRAINT [FK_GvaViewSModeCodes_GvaViewAircraftRegistrations] FOREIGN KEY ([AircraftId], [RegistrationPartIndex]) REFERENCES [dbo].[GvaViewAircraftRegistrations] ([LotId], [PartIndex]),
...
exec spDescColumn N'GvaViewSModeCodes', N'Description'           , N'Бележки.'
exec spDescColumn N'GvaViewSModeCodes', N'Identifier'            , N'Идентификатор.'
exec spDescColumn N'GvaViewSModeCodes', N'RegMark'               , N'Рег. знак'
exec spDescColumn N'GvaViewSModeCodes', N'AircraftId'            , N'Идентификационен номер на ВС на което е разпределен този код.'
exec spDescColumn N'GvaViewSModeCodes', N'RegistrationPartIndex' , N'Идентификационен номер на регистрация на ВС.'
