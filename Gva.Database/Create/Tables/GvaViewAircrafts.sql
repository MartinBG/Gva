...
CREATE TABLE [dbo].[GvaViewAircrafts] (
    ...
    CONSTRAINT [FK_GvaViewAircrafts_NomValues]  FOREIGN KEY ([EASATypeId]) REFERENCES [dbo].[NomValues] ([NomValueId]),
...
exec spDescColumn N'GvaViewAircrafts', N'EASATypeId', N'AIR Category.'
