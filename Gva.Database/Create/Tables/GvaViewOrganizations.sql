...
CREATE TABLE [dbo].[GvaViewOrganizations] (
    [GvaViewOrganizationLotId] INT           NOT NULL,
    ...
    CONSTRAINT [PK_GvaViewOrganizations]      PRIMARY KEY ([GvaViewOrganizationLotId]),
    CONSTRAINT [FK_GvaViewOrganizations_Lots]  FOREIGN KEY ([GvaViewOrganizationLotId]) REFERENCES [dbo].[Lots] ([LotId])
)
GO

exec spDescTable  N'GvaViewOrganizations', N'Организации.'
exec spDescColumn N'GvaViewOrganizations', N'GvaViewOrganizationLotId', N'Идентификатор на партида на организация.'
