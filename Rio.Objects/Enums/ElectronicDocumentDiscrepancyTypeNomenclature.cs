...
namespace Rio.Objects.Enums
{
    public class ElectronicDocumentDiscrepancyTypeNomenclature
    {
        ...
        public static readonly ElectronicDocumentDiscrepancyTypeNomenclature IncorrectAttachmentsFormat = new ElectronicDocumentDiscrepancyTypeNomenclature { Text = "Приложените към заявлението документи не са в нормативно установения формат", Uri = "0006-000007" };
