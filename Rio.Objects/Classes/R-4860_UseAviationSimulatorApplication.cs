...
namespace R_4860
{
	...
	{
		public const string SchemaVersion = "http://ereg.egov.bg/segment/R-4860";
	}
	...
	[XmlRoot(ElementName="UseAviationSimulatorApplication",Namespace=Declarations.SchemaVersion,IsNullable=false),Serializable]
	[XmlType(TypeName="UseAviationSimulatorApplication",Namespace=Declarations.SchemaVersion)]
	public partial class UseAviationSimulatorApplication
	{
		...
		[EditorBrowsable(EditorBrowsableState.Advanced)]
		public R_4848.Leadership Leadership { get; set; }
		...
		[EditorBrowsable(EditorBrowsableState.Advanced)]
		public R_4858.Premises Accommodation { get; set; }
		...
		[EditorBrowsable(EditorBrowsableState.Advanced)]
		public R_4858.Premises Premises { get; set; }
		...
		[System.Web.Script.Serialization.ScriptIgnore]
		[XmlElement(Type=typeof(UseAviationSimulatorApplicationAttachedDocuments),ElementName="AttachedDocuments",IsNullable=false,Form=XmlSchemaForm.Qualified,Namespace=Declarations.SchemaVersion)]
		[EditorBrowsable(EditorBrowsableState.Advanced)]
		public UseAviationSimulatorApplicationAttachedDocuments AttachedDocuments { get; set; }
		...
		public UseAviationSimulatorApplication()
		{
		}
	}


	[XmlType(TypeName="UseAviationSimulatorApplicationAttachedDocuments",Namespace=Declarations.SchemaVersion),Serializable]
	public partial class UseAviationSimulatorApplicationAttachedDocuments
	{
		...
		public UseAviationSimulatorApplicationAttachedDocuments()
		{
		}
	}
}
