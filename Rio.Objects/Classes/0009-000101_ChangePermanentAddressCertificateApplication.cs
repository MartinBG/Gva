...
namespace R_0009_000101
{

	public struct Declarations
	{
		public const string SchemaVersion = "http://ereg.egov.bg/segment/0009-000101";
	}
	...
	[XmlRoot(ElementName="ChangePermanentAddressCertificateApplication",Namespace=Declarations.SchemaVersion,IsNullable=false),Serializable]
	[XmlType(TypeName="ChangePermanentAddressCertificateApplication",Namespace=Declarations.SchemaVersion)]
	public partial class ChangePermanentAddressCertificateApplication
	{
		...
		[System.Web.Script.Serialization.ScriptIgnore]
		[XmlElement(Type=typeof(ChangePermanentAddressCertificateApplicationAttachedDocuments),ElementName="AttachedDocuments",IsNullable=false,Form=XmlSchemaForm.Qualified,Namespace=Declarations.SchemaVersion)]
		[EditorBrowsable(EditorBrowsableState.Advanced)]
		public ChangePermanentAddressCertificateApplicationAttachedDocuments __AttachedDocuments;
		
		[XmlIgnore]
		public ChangePermanentAddressCertificateApplicationAttachedDocuments AttachedDocuments
		{
		...
		public ChangePermanentAddressCertificateApplication()
		{
		}
	}


	[XmlType(TypeName="ChangePermanentAddressCertificateApplicationAttachedDocuments",Namespace=Declarations.SchemaVersion),Serializable]
	public partial class ChangePermanentAddressCertificateApplicationAttachedDocuments
	{
		...
		public ChangePermanentAddressCertificateApplicationAttachedDocuments()
		{
		}
	}
}
