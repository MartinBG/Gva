...
namespace R_4606
{
	...
	public partial class LicenseOperatorApplication
	{
		...
		[EditorBrowsable(EditorBrowsableState.Advanced)]
		public ServiceCategoryCollection __ServiceCategoryCollection;
		
		[XmlIgnore]
		public ServiceCategoryCollection ServiceCategoryCollection
		{
			get
			{
				if (__ServiceCategoryCollection == null) __ServiceCategoryCollection = new ServiceCategoryCollection();
				return __ServiceCategoryCollection;
			}
			set {__ServiceCategoryCollection = value;}
		}
		...
		[EditorBrowsable(EditorBrowsableState.Advanced)]
		public LicenseOperatorApplicationAttachedDocuments __AttachedDocuments;
		
		[XmlIgnore]
		public LicenseOperatorApplicationAttachedDocuments AttachedDocuments
		{
