...
namespace R_5242
{
	...
	{
		public const string SchemaVersion = "http://ereg.egov.bg/segment/R-5242";
	}
	...
	[XmlRoot(ElementName="RegistrationTrainingAircraftTypePermissionStewardHostessApplication",Namespace=Declarations.SchemaVersion,IsNullable=false),Serializable]
	[XmlType(TypeName="RegistrationTrainingAircraftTypePermissionStewardHostessApplication",Namespace=Declarations.SchemaVersion)]
	public partial class RegistrationTrainingAircraftTypePermissionStewardHostessApplication
	{
		...
		[System.Web.Script.Serialization.ScriptIgnore]
		[XmlElement(Type=typeof(RegistrationTrainingAircraftTypePermissionStewardHostessApplicationAttachedDocuments),ElementName="AttachedDocuments",IsNullable=false,Form=XmlSchemaForm.Qualified,Namespace=Declarations.SchemaVersion)]
		[EditorBrowsable(EditorBrowsableState.Advanced)]
		public RegistrationTrainingAircraftTypePermissionStewardHostessApplicationAttachedDocuments AttachedDocuments { get; set; }
		...
		public RegistrationTrainingAircraftTypePermissionStewardHostessApplication()
		{
		}
	}


	[XmlType(TypeName="RegistrationTrainingAircraftTypePermissionStewardHostessApplicationAttachedDocuments",Namespace=Declarations.SchemaVersion),Serializable]
	public partial class RegistrationTrainingAircraftTypePermissionStewardHostessApplicationAttachedDocuments
	{
		...
		public RegistrationTrainingAircraftTypePermissionStewardHostessApplicationAttachedDocuments()
		{
		}
	}
}
