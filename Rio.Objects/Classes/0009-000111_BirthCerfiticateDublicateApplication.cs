...
namespace R_0009_000111
{

	public struct Declarations
	{
		public const string SchemaVersion = "http://ereg.egov.bg/segment/0009-000111";
	}
	...
	[XmlRoot(ElementName="BirthCerfiticateDublicateApplication",Namespace=Declarations.SchemaVersion,IsNullable=false),Serializable]
	[XmlType(TypeName="BirthCerfiticateDublicateApplication",Namespace=Declarations.SchemaVersion)]
	public partial class BirthCerfiticateDublicateApplication
	{
		...
		[System.Web.Script.Serialization.ScriptIgnore]
		[XmlElement(Type=typeof(BirthCerfiticateDublicateApplicationAttachedDocuments),ElementName="AttachedDocuments",IsNullable=false,Form=XmlSchemaForm.Qualified,Namespace=Declarations.SchemaVersion)]
		[EditorBrowsable(EditorBrowsableState.Advanced)]
		public BirthCerfiticateDublicateApplicationAttachedDocuments __AttachedDocuments;
		
		[XmlIgnore]
		public BirthCerfiticateDublicateApplicationAttachedDocuments AttachedDocuments
		{
		...
		public BirthCerfiticateDublicateApplication()
		{
		}
	}


	[XmlType(TypeName="BirthCerfiticateDublicateApplicationAttachedDocuments",Namespace=Declarations.SchemaVersion),Serializable]
	public partial class BirthCerfiticateDublicateApplicationAttachedDocuments
	{
		...
		public BirthCerfiticateDublicateApplicationAttachedDocuments()
		{
		}
	}
}
