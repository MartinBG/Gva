...
namespace R_1007
{
	...
	{
		public const string SchemaVersion = "http://ereg.egov.bg/segment/R-1007";
	}
	...
	[XmlRoot(ElementName="DemandCertificateRegistrationPopulationRegister",Namespace=Declarations.SchemaVersion,IsNullable=false),Serializable]
	[XmlType(TypeName="DemandCertificateRegistrationPopulationRegister",Namespace=Declarations.SchemaVersion)]
	public partial class DemandCertificateRegistrationPopulationRegister
	{
		...
		[System.Web.Script.Serialization.ScriptIgnore]
		[XmlElement(Type=typeof(DemandCertificateRegistrationPopulationRegisterAttachedDocuments),ElementName="AttachedDocuments",IsNullable=false,Form=XmlSchemaForm.Qualified,Namespace=Declarations.SchemaVersion)]
		[EditorBrowsable(EditorBrowsableState.Advanced)]
		public DemandCertificateRegistrationPopulationRegisterAttachedDocuments AttachedDocuments { get; set; }
		...
		public DemandCertificateRegistrationPopulationRegister()
		{
		}
	}


	[XmlType(TypeName="DemandCertificateRegistrationPopulationRegisterAttachedDocuments",Namespace=Declarations.SchemaVersion),Serializable]
	public partial class DemandCertificateRegistrationPopulationRegisterAttachedDocuments
	{
		...
		public DemandCertificateRegistrationPopulationRegisterAttachedDocuments()
		{
		}
	}
}
