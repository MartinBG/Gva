...
namespace R_4356
{
	...
	{
		public const string SchemaVersion = "http://ereg.egov.bg/segment/R-4356";
	}
	...
	[XmlRoot(ElementName="AircraftRegistrationCertificateApplication",Namespace=Declarations.SchemaVersion,IsNullable=false),Serializable]
	[XmlType(TypeName="AircraftRegistrationCertificateApplication",Namespace=Declarations.SchemaVersion)]
	public partial class AircraftRegistrationCertificateApplication
	{
		...
		[System.Web.Script.Serialization.ScriptIgnore]
		[XmlElement(Type=typeof(R_3994.AttachedDocumentDatasCollection),ElementName="AircraftHiringDataAttachedDocumentDatasCollection",IsNullable=false,Form=XmlSchemaForm.Qualified,Namespace=Declarations.SchemaVersion)]
		[EditorBrowsable(EditorBrowsableState.Advanced)]
		public R_3994.AttachedDocumentDatasCollection AircraftHiringDataAttachedDocumentDatasCollection { get; set; }
		...
		[System.Web.Script.Serialization.ScriptIgnore]
		[XmlElement(Type=typeof(R_4350.AircraftManufactureData),ElementName="AircraftManufactureData",IsNullable=false,Form=XmlSchemaForm.Qualified,Namespace=Declarations.SchemaVersion)]
		[EditorBrowsable(EditorBrowsableState.Advanced)]
		public R_4350.AircraftManufactureData AircraftManufactureData { get; set; }
		...
		[System.Web.Script.Serialization.ScriptIgnore]
		[XmlElement(Type=typeof(AircraftRegistrationCertificateApplicationAttachedDocuments),ElementName="AttachedDocuments",IsNullable=false,Form=XmlSchemaForm.Qualified,Namespace=Declarations.SchemaVersion)]
		[EditorBrowsable(EditorBrowsableState.Advanced)]
		public AircraftRegistrationCertificateApplicationAttachedDocuments AttachedDocuments { get; set; }
		...
		public AircraftRegistrationCertificateApplication()
		{
		}
	}


	[XmlType(TypeName="AircraftRegistrationCertificateApplicationAttachedDocuments",Namespace=Declarations.SchemaVersion),Serializable]
	public partial class AircraftRegistrationCertificateApplicationAttachedDocuments
	{
		...
		public AircraftRegistrationCertificateApplicationAttachedDocuments()
		{
		}
	}
}
