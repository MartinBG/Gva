...
namespace R_5104
{
	...
	{
		public const string SchemaVersion = "http://ereg.egov.bg/segment/R-5104";
	}
	...
	[XmlRoot(ElementName="ApprovalProgramPlanMaintenanceAircraftApplication",Namespace=Declarations.SchemaVersion,IsNullable=false),Serializable]
	[XmlType(TypeName="ApprovalProgramPlanMaintenanceAircraftApplication",Namespace=Declarations.SchemaVersion)]
	public partial class ApprovalProgramPlanMaintenanceAircraftApplication
	{
		...
		[System.Web.Script.Serialization.ScriptIgnore]
		[XmlElement(Type=typeof(ApprovalProgramPlanMaintenanceAircraftApplicationAttachedDocuments),ElementName="AttachedDocuments",IsNullable=false,Form=XmlSchemaForm.Qualified,Namespace=Declarations.SchemaVersion)]
		[EditorBrowsable(EditorBrowsableState.Advanced)]
		public ApprovalProgramPlanMaintenanceAircraftApplicationAttachedDocuments AttachedDocuments { get; set; }
		...
		public ApprovalProgramPlanMaintenanceAircraftApplication()
		{
		}
	}


	[XmlType(TypeName="ApprovalProgramPlanMaintenanceAircraftApplicationAttachedDocuments",Namespace=Declarations.SchemaVersion),Serializable]
	public partial class ApprovalProgramPlanMaintenanceAircraftApplicationAttachedDocuments
	{
		...
		public ApprovalProgramPlanMaintenanceAircraftApplicationAttachedDocuments()
		{
		}
	}
}
