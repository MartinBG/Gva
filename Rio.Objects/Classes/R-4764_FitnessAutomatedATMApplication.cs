...
namespace R_4764
{
	...
	{
		public const string SchemaVersion = "http://ereg.egov.bg/segment/R-4764";
	}
	...
	[XmlRoot(ElementName="FitnessAutomatedATMApplication",Namespace=Declarations.SchemaVersion,IsNullable=false),Serializable]
	[XmlType(TypeName="FitnessAutomatedATMApplication",Namespace=Declarations.SchemaVersion)]
	public partial class FitnessAutomatedATMApplication
	{
		...
		[EditorBrowsable(EditorBrowsableState.Advanced)]
		public R_4762.FacilityData __FacilityData;
		
		[XmlIgnore]
		public R_4762.FacilityData FacilityData
		{
			get {return __FacilityData;}
			set {__FacilityData = value;}
		}
		...
		[System.Web.Script.Serialization.ScriptIgnore]
		[XmlElement(Type=typeof(FitnessAutomatedATMApplicationAttachedDocuments),ElementName="AttachedDocuments",IsNullable=false,Form=XmlSchemaForm.Qualified,Namespace=Declarations.SchemaVersion)]
		[EditorBrowsable(EditorBrowsableState.Advanced)]
		public FitnessAutomatedATMApplicationAttachedDocuments __AttachedDocuments;
		
		[XmlIgnore]
		public FitnessAutomatedATMApplicationAttachedDocuments AttachedDocuments
		{
		...
		public FitnessAutomatedATMApplication()
		{
		}
	}


	[XmlType(TypeName="FitnessAutomatedATMApplicationAttachedDocuments",Namespace=Declarations.SchemaVersion),Serializable]
	public partial class FitnessAutomatedATMApplicationAttachedDocuments
	{
		...
		public FitnessAutomatedATMApplicationAttachedDocuments()
		{
		}
	}
}
