...
namespace R_0009_000125
{

	public struct Declarations
	{
		public const string SchemaVersion = "http://ereg.egov.bg/segment/0009-000125";
	}




	[XmlType(TypeName="DeathLocation",Namespace=Declarations.SchemaVersion),Serializable]
	...
	public partial class DeathLocation
	{
		...
		[System.Web.Script.Serialization.ScriptIgnore]
		[XmlElement(ElementName="PlaceOfDeath",IsNullable=false,Form=XmlSchemaForm.Qualified,DataType="string",Namespace=Declarations.SchemaVersion)]
		[EditorBrowsable(EditorBrowsableState.Advanced)]
		public string __PlaceOfDeath;
		
		[XmlIgnore]
		public string PlaceOfDeath
		{ 
			get { return __PlaceOfDeath; }
			set { __PlaceOfDeath = value; }
		}
