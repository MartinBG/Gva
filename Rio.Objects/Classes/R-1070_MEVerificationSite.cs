...
namespace R_1070
{
	...
	{
		public const string SchemaVersion = "http://ereg.egov.bg/segment/R-1070";
	}




	[XmlType(TypeName="MEVerificationSite",Namespace=Declarations.SchemaVersion),Serializable]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	public partial class MEVerificationSite
	{

		[System.Web.Script.Serialization.ScriptIgnore]
		[XmlElement(ElementName="MEVerificationSiteTypeCode",IsNullable=false,Form=XmlSchemaForm.Qualified,DataType="string",Namespace=Declarations.SchemaVersion)]
		[EditorBrowsable(EditorBrowsableState.Advanced)]
		public string MEVerificationSiteTypeCode { get; set; }

		[System.Web.Script.Serialization.ScriptIgnore]
		[XmlElement(ElementName="MEVerificationSiteTypeName",IsNullable=false,Form=XmlSchemaForm.Qualified,DataType="string",Namespace=Declarations.SchemaVersion)]
		[EditorBrowsable(EditorBrowsableState.Advanced)]
		public string MEVerificationSiteTypeName { get; set; }
