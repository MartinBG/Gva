...
namespace R_0009_000039
{
	...
	public partial class AdministrativeNomenclatureServiceStageResults
	{
		...
		[EditorBrowsable(EditorBrowsableState.Advanced)]
		public AdministrativeNomenclatureServiceStageResultElementCollection __ServiceStageResultCollection;
		
		[XmlIgnore]
		public AdministrativeNomenclatureServiceStageResultElementCollection ServiceStageResultCollection
		{
			get
			{
				if (__ServiceStageResultCollection == null) __ServiceStageResultCollection = new AdministrativeNomenclatureServiceStageResultElementCollection();
				return __ServiceStageResultCollection;
			}
			set {__ServiceStageResultCollection = value;}
		}
