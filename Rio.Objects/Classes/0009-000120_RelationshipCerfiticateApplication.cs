...
namespace R_0009_000120
{

	public struct Declarations
	{
		public const string SchemaVersion = "http://ereg.egov.bg/segment/0009-000120";
	}
	...
	[XmlRoot(ElementName="RelationshipCerfiticateApplication",Namespace=Declarations.SchemaVersion,IsNullable=false),Serializable]
	[XmlType(TypeName="RelationshipCerfiticateApplication",Namespace=Declarations.SchemaVersion)]
	public partial class RelationshipCerfiticateApplication
	{
		...
		[System.Web.Script.Serialization.ScriptIgnore]
		[XmlElement(Type=typeof(RelationshipCerfiticateApplicationAttachedDocuments),ElementName="AttachedDocuments",IsNullable=false,Form=XmlSchemaForm.Qualified,Namespace=Declarations.SchemaVersion)]
		[EditorBrowsable(EditorBrowsableState.Advanced)]
		public RelationshipCerfiticateApplicationAttachedDocuments __AttachedDocuments;
		
		[XmlIgnore]
		public RelationshipCerfiticateApplicationAttachedDocuments AttachedDocuments
		{
		...
		public RelationshipCerfiticateApplication()
		{
		}
	}


	[XmlType(TypeName="RelationshipCerfiticateApplicationAttachedDocuments",Namespace=Declarations.SchemaVersion),Serializable]
	public partial class RelationshipCerfiticateApplicationAttachedDocuments
	{
		...
		public RelationshipCerfiticateApplicationAttachedDocuments()
		{
		}
	}
}
