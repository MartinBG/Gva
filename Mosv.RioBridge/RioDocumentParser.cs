...
namespace Mosv.Rio.PortalBridge
{
    public class RioDocumentParser : IRioDocumentParser
    {
        ...
        public Common.Rio.PortalBridge.RioObjects.RioApplication XmlDeserializeApplication(string xmlContent)
        {
            ...
            var mappedApplication = (Common.Rio.PortalBridge.RioObjects.RioApplication)AutoMapper.Mapper.Map(rioApplication, typeof(IHeaderDocumentsRioApplication), typeof(Common.Rio.PortalBridge.RioObjects.RioApplication));
