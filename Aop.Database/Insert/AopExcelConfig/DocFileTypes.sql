...
INSERT INTO [DocFileTypes]([DocFileTypeId], [Name], [Alias], [DocTypeUri], [HasEmbeddedUri], [MimeType], [Extention], [IsEditable], [IsActive]) VALUES(1001,N'Чеклист',N'Checklist',N'Checklist',0,'application/xml','.xml',1,1);
