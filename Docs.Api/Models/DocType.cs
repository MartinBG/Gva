...
namespace Docs.Api.Models
{
    public partial class DocType
    {
        ...
        public Nullable<int> PrimaryRegisterIndexId { get; set; }
        public Nullable<int> SecondaryRegisterIndexId { get; set; }
        ...
        public Nullable<int> ExecutionDeadline { get; set; }
        public Nullable<int> RemoveIrregularitiesDeadline { get; set; }
