...
AS 
select d.DocId, ut.UnitId, ut.ClassificationPermissionId,  COUNT_BIG(*) as _c1 
from dbo.Docs d
...
group by d.DocId, ut.UnitId, ut.ClassificationPermissionId 
go

CREATE UNIQUE CLUSTERED INDEX vwDocUsers_PK 
	ON vwDocUsers (UnitId, ClassificationPermissionId, DocId  )
