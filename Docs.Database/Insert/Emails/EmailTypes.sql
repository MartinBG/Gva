...
VALUES (1, N'CorrespondentEmail', N'CorrespondentEmail',
        ...
        N'Има нов електронен документ по ваша преписка <b>@@CaseNum</b> към портала за електронни административни услуги на "Министерство на правосъдието", който ви изпращаме приложено.<br>' +
...
VALUES (2, N'ReceiptAcknowledgedEmail', N'ReceiptAcknowledgedEmail',
        ...
        N'Вашето заявление, подадено през портала за електронни административни услуги на "Министерство на правосъдието", е потвърдено.<br>' +
...
VALUES (3, N'ReceiptNotAcknowledgedEmail', N'ReceiptNotAcknowledgedEmail',
        ...
        N'Вашето заявление, подадено през портала за електронни административни услуги на "Министерство на правосъдието", е отхвърлено.<br>' +
